$(document).ready(function(){
	...
	$('#video-twitchVideos #submit-videos, #video-dailymotionVideos #submit-videos, #video-vimeoVideos #submit-videos,#video-fbVideos #submit-videos,#video-ytVideos #submit-videos').click(function(e){
		e.preventDefault();
		var data = [];
